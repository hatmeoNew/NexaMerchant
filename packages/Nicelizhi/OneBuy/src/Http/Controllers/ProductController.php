...
class ProductController extends Controller
{
    ...
    public function checkout_success(Request $request)
    {
        ...
        return view('onebuy::checkout-success', compact(
            'order',
            "fb_ids",
            "ob_adv_id",
            "crm_channel",
    ...
    public function checkout_success_v4($order_id, Request $request)
    {
        ...
        return view('onebuy::checkout-success-v4', compact(
            'order',
            "fb_ids",
            "ob_adv_id",
            "crm_channel",
    ...
    public function checkout_success_v2($order_id, Request $request)
    {
        ...
        return view('onebuy::checkout-success-v2', compact(
            'order',
            "fb_ids",
            "ob_adv_id",
            "crm_channel",
    ...
    public function checkout_success_v1($order_id, Request $request)
    {
        ...
        return view('onebuy::checkout-success-v1', compact(
            'order',
            "fb_ids",
            "ob_adv_id",
            "crm_channel",
